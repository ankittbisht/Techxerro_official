  ...
  return (
    <div className={styles.cardsWrapper}>    
      <OwlCarousel items={4}>   
        ...
        <div className={styles.cards} >
          <div className={styles.posterImg }>
            <img src={require('../../../assets/services/fb-marketing.png')} alt=""/>
          </div>
          <div className={styles.cardContent}>
        ...
        <div className={styles.cards} >
          <div className={styles.posterImg }>
            <img src={require('../../../assets/services/influencer-marketing.png')} alt=""/>
          </div>
          <div className={styles.cardContent}>
  ...
  return ( 
      <div className={styles.cardsWrapper}>             
        <div className={styles.cards} >
          ...
          <div className={styles.cardContent}>
            <p><b>Animation AND  Motion Graphics</b></p>
            <ul style={{padding: '0', listStyleType: 'none', opacity:'0.8'}}>
              <li>2D/3D animation</li>
              <li>Video editing & production</li>
              <li>Animated logos & intros</li>
    ...
    <div className={styles.cardContainer}>      
      ...
      >
        <div className={styles.servicessectionwappper}>
            <h4>{title}</h4>
            <Tabs>
            <TabList className="section-tabs servicestab">
