...
export default function Technologies(props) {
  const inditems = [
      ...
      logos: [
        {
          ...
          img: (
            <img
              src={require("../../../assets/Home/technologies/logo/logo1.png")}
              alt="Logo 1"
            />
          ),
        },
        {
          ...
          img: (
            <img
              src={require("../../../assets/Home/technologies/logo/logo3.png")}
              alt="Logo 1"
            />
          ),
        },
        {
          ...
          img: (
            <img
              src={require("../../../assets/Home/technologies/logo/logo4.png")}
              alt="Logo 1"
            />
          ),
        },
    ...
    },
    {
      ...
      heading: [
        <h3>
          Building Tomorrow,
          <br />
          <span>Your Blueprint to Success</span>
        </h3>,
      ],
      ...
      logos: [
        {
          ...
          img: (
            <img
              src={require("../../../assets/Home/technologies/logo/logo2.png")}
              alt="Logo 1"
            />
          ),
        },
    ...
    },
    {
      ...
      heading: [
        <h3>
          <span>Creating Experiences</span>, <br />
          One Stay at a Time
        </h3>,
      ],
      ...
      logos: [
        {
          ...
          img: (
            <img
              src={require("../../../assets/Home/technologies/logo/logo5.png")}
              alt="Logo 1"
            />
          ),
        },
    ...
    },
    {
      ...
      heading: [
        <h3>
          Driving Innovation <span>Roadmap</span>
          <br /> to Excellence
        </h3>,
      ],
      ...
      logos: [
        {
          ...
          img: (
            <img
              src={require("../../../assets/Home/technologies/logo/logo6.png")}
              alt="Logo 1"
            />
          ),
        },
                    ...
                    <div className="content">
                      ...
                      <div class="logos d-flex">
                        {obj.logos.map((logoobj) => {
                          return <div key={logoobj.logoid}>{logoobj.img}</div>;
                        })}
                      </div>
