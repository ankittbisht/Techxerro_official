            ...
            <div className="row teamsheaderRow">
              <div className="col-12">
                <a href="/blogs" className="d-flex gap-2 align-items-center">
                  ...
                  >
                    <path
                      d="M0.645809 4.35355C0.450548 4.15829 0.450548 3.84171 0.645809 3.64645L3.82779 0.464466C4.02305 0.269204 4.33963 0.269204 4.5349 0.464466C4.73016 0.659728 4.73016 0.976311 4.5349 1.17157L1.70647 4L4.5349 6.82843C4.73016 7.02369 4.73016 7.34027 4.5349 7.53553C4.33963 7.7308 4.02305 7.7308 3.82779 7.53553L0.645809 4.35355ZM27.0762 4.5H0.999363V3.5L27.0762 3.5V4.5Z"
                      fill="#989898"
                    />
                  </svg>
                  Back to all blogs
                ...
                <img src={singleBlogbanner} className="img-fluid" alt="" />
              </div>
              <div className="col-lg-9 col-12 content">
                ...
                <p>
                  ...
                  lectus vel dictum at morbi. Dictum mattis turpis adipiscing
                  dictum. Non molestie tincidunt facilisi etiam sapien. Sed sed
                  aenean pellentesque id sagittis ullamcorper. Tellus tristique
                  sed eu amet sagittis sed ac. Tincidunt et in morbi netus. Nec
                  eget nisi ut consectetur urna arcu. Hac malesuada urna urna
                  viverra ac orci. Semper tristique risus nunc in nibh. Sapien
                  pulvinar amet purus consequat rutrum dictum. Suspendisse amet
                  nibh fringilla diam risus ut morbi quam dignissim.
                </p>
                <p>
                  Lorem ipsum dolor sit amet consectetur. Commodo sed risus
                  laoreet enim eget ac lacinia egestas lectus. Arcu lectus
              ...
              <div className="col-lg-3 col-12">
                <div className="sidebar">
                  ...
                  <hr />
                  <div>
                    <h3 className="d-flex gap-5 align-items-center pt-3 pb-2">
                      Find Us At
                      <svg
                        width="9"
                        height="16"
